...
moveleft:
	...
	# Decrementing the x-coordinate by 1
	addi a0, a0, -1
...
movedown:
	...
	# Decrementing the y-coordinate by 1
	addi a1, a1, 1
...
moveright:
	...
	# Incrementing the x-coordinate by 1
	addi a0, a0, 1
...
moveDiagonalLeftUp:
	...
	# Decrementing both the x- and y-coordinates with 1
	addi a0, a0, -1
	addi a1, a1, -1
...
moveDiagonalLeftDown:
	...
	# Decrementing the x-coordinate with 1 and incrementing the y-coordinate with 1
	addi a0, a0, -1
	addi a1, a1, 1	
...
moveDiagonalRightUp:
	...
	# Incrementing the x-coordinate with 1 and decrementing the y-coordinate with 1
	addi a0, a0, 1
	addi a1, a1, -1
...
moveDiagonalRightDown:
	...
	# Incrementing both the x- and y-coordinates with 1
